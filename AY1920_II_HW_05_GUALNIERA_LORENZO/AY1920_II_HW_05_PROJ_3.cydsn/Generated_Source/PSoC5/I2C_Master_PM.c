...
I2C_Master_BACKUP_STRUCT I2C_Master_backup =
{
    ...
    I2C_Master_DEFAULT_XCFG,
    I2C_Master_DEFAULT_CFG,
    I2C_Master_DEFAULT_ADDR,
    LO8(I2C_Master_DEFAULT_DIVIDE_FACTOR),
    HI8(I2C_Master_DEFAULT_DIVIDE_FACTOR),
...
*
* Global Variables:
*  I2C_Master_backup - The global variable used to save the component
...
*
* Side Effects:
*  Calling this function before I2C_Master_SaveConfig() or
*  I2C_Master_Sleep() will lead to unpredictable results.
*
*******************************************************************************/
void I2C_Master_RestoreConfig(void) 
{
    ...
    if (I2C_Master_CHECK_PWRSYS_I2C_BACKUP)
