...
*
* Global variables:
*  I2C_Master_mstrStatus  - The global variable used to store a current
*                                 status of the I2C Master.
*  I2C_Master_state       - The global variable used to store a current
*                                 state of the software FSM.
*  I2C_Master_mstrControl - The global variable used to control the master
*                                 end of a transaction with or without Stop
*                                 generation.
*  I2C_Master_mstrWrBufPtr - The global variable used to store a pointer
*                                  to the master write buffer.
*  I2C_Master_mstrWrBufIndex - The global variable used to store current
*                                    index within the master write buffer.
*  I2C_Master_mstrWrBufSize - The global variable used to store a master
*                                   write buffer size.
*
* Reentrant:
*  No
...
*                                 Stop generation.
*  I2C_Master_mstrRdBufPtr - The global variable used to store a pointer
*                                  to the master write buffer.
*  I2C_Master_mstrRdBufIndex - The global variable  used to store a
*                                    current index within the master
*                                    write buffer.
*  I2C_Master_mstrRdBufSize - The global variable used to store a master
*                                   write buffer size.
*
* Reentrant:
*  No.
      ...
      
{
    ...
    if(NULL != rdData)
    {
        ...
        {
            /* errStatus = I2C_Master_MSTR_NOT_READY was set before */
        }
...
*
* Global variables:
*  I2C_Master_state - The global variable used to store a current state of
*                           the software FSM.
*
* Reentrant:
*  No.
...
uint8 I2C_Master_MasterSendStop(void) 
{
    ...
    if(I2C_Master_CHECK_MASTER_MODE(I2C_Master_MCSR_REG))
    {
        I2C_Master_GENERATE_STOP_MANUAL;
        I2C_Master_state = I2C_Master_SM_IDLE;
...
uint8 I2C_Master_MasterStatus(void) 
{
    ...
    I2C_Master_DisableInt(); /* Lock from interrupt */
...
*
* Global variables:
*  I2C_Master_mstrRdBufIndex - The global variable stores current index
...
*
* Global variables:
*  I2C_Master_mstrWrBufIndex -  The global variable used to stores current
...
*
* Global variables:
*  I2C_Master_mstrRdBufIndex - The global variable used to stores current
...
*
* Global variables:
*  I2C_Master_mstrRdBufIndex - The global variable used to stote current
*                                    index within master read buffer.
*  I2C_Master_mstrStatus - The global variable used to store a current
*                                status of the I2C Master.
*
