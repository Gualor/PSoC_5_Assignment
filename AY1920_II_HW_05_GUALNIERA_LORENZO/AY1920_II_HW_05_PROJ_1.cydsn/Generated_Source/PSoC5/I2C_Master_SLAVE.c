...
*
* Global variables:
*  I2C_Master_slStatus - The global variable used to store a current
...
*
* Global variables:
*  I2C_Master_Address  - The global variable used to store an I2C slave
...
*
* Global variables:
*  I2C_Master_slRdBufPtr   - The global variable used to store a pointer
*                                  to the slave read buffer.
*  I2C_Master_slRdBufSize  - The global variable used to store a slave
*                                  read buffer size.
*  I2C_Master_slRdBufIndex - The global variable used to store a current
     ...
     
{
    if (NULL != rdBuf)
    {
        ...
        /* Set buffer pointer */
        I2C_Master_slRdBufPtr   = (volatile uint8 *) rdBuf;
...
*
* Global variables:
*  I2C_Master_slWrBufPtr   - The global variable used to store a pointer
*                                  to the slave write buffer.
*  I2C_Master_slWrBufSize  - The global variable used to store a slave
*                                  write buffer size.
*  I2C_Master_slWrBufIndex - The global variable used to store a current
     ...
     
{
    if (NULL != wrBuf)
    {
        I2C_Master_DisableInt(); /* Lock from interrupt */
         ...
         /* Set buffer pointer */
        I2C_Master_slWrBufPtr   = (volatile uint8 *) wrBuf;
